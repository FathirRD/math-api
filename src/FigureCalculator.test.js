...
describe('A FigureCalculator', () => {
  it(`should contain calculateRectanglePerimeter,
      calculateRectangleArea, calculateTrianglePerimeter,
  ...
  describe('A calculateRectangleArea function', () => {
    ...
    it('should return correct value based on rectangle area formula', () => {
      ...
      expect(spyMultiply).toHaveBeenCalledWith(20, 10); // Length and Width
    });
  });
  ...
  describe('A calculateTrianglePerimeter function', () => {
    ...
    it('should throw error when given with non-number parameters', () => {
      ...
      expect(() => figureCalculator.calculateTrianglePerimeter([], {}, 99)).toThrowError();
    });
    ...
    it('should return correct value based on triangle perimeter formula', () => {
      ...
      // Assert
      expect(result).toEqual(45); // a + b + c
      expect(spyAdd).toHaveBeenCalledWith(a, b, c);
    });
  });

  describe('A calculateTriagleArea function', () => {
    it('should throw error when not given 2 parameters', () => {
      const figureCalculator = new FigureCalculator({});
    ...
    it('should return correct value based on triangle area formula', () => {
      ...
      // Assert
      expect(result).toEqual(60); // Base * Height / 2
      expect(spyMultiply).toHaveBeenCalledWith(12, 10); // Length and Width
      expect(spyDivide).toHaveBeenCalledWith(120, 2); // (base * height) / 2
    });
  });
});
