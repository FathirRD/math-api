...
describe('A MathBasic', () => {
  ...
  describe('A add function', () => {
    ...
    it('should return a + b when given two number parameters', () => {
      ...
      expect(MathBasic.add(3, 7, 3, 2, 4, 10)).toEqual(29);
    });
  });
  ...
  describe('A subtract function', () => {
    ...
    it('should return a - b when given two number parameters', () => {
      ...
      expect(MathBasic.subtract(16, 6)).toEqual(10);
      expect(MathBasic.subtract(0, 7)).toEqual(-7);
    });
  });
  ...
  describe('A multiply function', () => {
    ...
    it('should return a * b when given two number parameters', () => {
      ...
      expect(MathBasic.multiply(1, 6)).toEqual(6);
      expect(MathBasic.multiply(0, 7)).toEqual(0);
    });
  });
  ...
  describe('A divide function', () => {
    ...
    it('should return a / b when given two number parameters', () => {
      ...
      expect(MathBasic.divide(0, 7)).toEqual(0);
    });

    it("should error if b is 0 (divider can't be zero)", () => {
      expect(() => MathBasic.divide(2, 0)).toThrowError();
